		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lista Pedidos",
									"targetURL": "#comtemapedidos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtemapedidos-display": {
								"semanticObject": "comtemapedidos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tema.pedidos",
									"url": sap.ui.require.toUrl("com/tema/pedidos")
								}
							}
						}
					}
